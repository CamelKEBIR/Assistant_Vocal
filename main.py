...
todo_list = ["wash clothes", "Buy some food & drink", "go to the supamarket", "Send an email" ]
    ...
    while not done:
        try:
            ...
            with speech_recognition.Microphone() as mic:
                ...
                note = recognizer.recognizer_google(audio)
                note = note.lower()
    ...
    while not done:
        try:
            ...
            with speech_recognition.Microphone() as mic:
                ...
                item = speech_recognition.recognize_google(audio)
                item = item.lower()
